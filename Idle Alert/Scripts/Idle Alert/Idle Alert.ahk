...
; Gui Buttons
	...
	Gui, Add, Button, xp y+62 w60 h40 vBtnScanRefresh gScanRefresh, Scan`nObject
	Gui, Add, Button, xp y+6 w60 h40 vBtnCheckObject gCheck_Object, Check`nObject
	Gui, Add, Button, xp y+52 w60 h20 vBtnAbout gAbout, About
...
About:
	...
	MsgBox, 4128, Idle Alert, Idle Alert is an application for Brighter Shores, a game created by Andrew Gower, the creator of RuneScape. The purpose of this app is to alert you whenever you become idle during crafting or combat.`n`nA video guide is included for those seeking assistance. It walks you through the process clearly and simply.
	SoundPlay, %Button_Click%
	Return
