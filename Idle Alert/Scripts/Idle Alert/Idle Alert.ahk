...
; Set Sound Effects
	...
	Button_Exit_Scan = %A_ScriptDir%\Sound\Button\MP3\Exit Scan.mp3
...
About:
	...
	MsgBox, 4128, Idle Alert, Idle Alert is an application that notifies you whenever you become idle during crafting or combat.`n`nThis application is for Brighter Shores, a game developed by Andrew Gower, the creator of RuneScape.
	SoundPlay, %Button_Click%
	Return
...
Video:
	MsgBox, 4148, Idle Alert, You are about to visit an external link to YouTube. This video tutorial explains how to use Idle Alert. Click 'Yes' to continue.
	IfMsgBox, Yes
